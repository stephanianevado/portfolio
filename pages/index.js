            ...
            <Body translate="no">
                ...
                <Main>
                    <section id="welcome-section" className="welcome-section">
                        ...
                        <h4>I'm a nutritionist, manager, writer and now I'm a web development &hearts;</h4>
                    </section>
                    <Div className="grid">
                        <Link id="about-me" href="/about">
                            <a className="card">
                                <h5><b>01.</b> About &rarr;</h5>
                                <p>Do or do not. There is no try. May the force be with me!!</p>
                            </a>
                        </Link>
                        <Link id="my-skills" href="/myskills">
                            <a className="card">
                                <h5><b>02.</b> My skills &rarr;</h5>
